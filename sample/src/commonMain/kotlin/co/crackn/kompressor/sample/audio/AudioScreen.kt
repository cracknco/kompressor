...
@Composable
fun AudioScreen(
    viewModel: AudioCompressViewModel,
    ...
    Box(modifier = modifier.fillMaxSize()) {
        Column(
            ...
            if (state.selectedAudioPath != null && state.result == null) {
                AudioPresetSelector(
                    selectedPreset = state.selectedPreset,
                    onPresetSelected = viewModel::onPresetSelected,
                )

                AudioCustomConfigPanel(
                    visible = state.selectedPreset == AudioPresetOption.CUSTOM,
                    bitrate = state.customBitrate,
                    sampleRate = state.customSampleRate,
                    channels = state.customChannels,
                    onBitrateChanged = viewModel::onCustomBitrateChanged,
                    onSampleRateChanged = viewModel::onCustomSampleRateChanged,
                    onChannelsChanged = viewModel::onCustomChannelsChanged,
                )
